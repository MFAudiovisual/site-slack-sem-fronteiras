<template>
  <footer
    class="z-10 bg-extra-dark/95 text-gray-300 pt-20 pb-6 lg:pt-20 lg:pb-6"
  >
      ...
      <div class="mx-4 flex flex-wrap">
        ...
        <div class="w-full px-4 sm:w-2/3 lg:w-3/12">
          <div class="mb-10 w-full">
            ...
            <p class="text-gray-400 font-semibold text-base mb-2">
              {{ company.description }}
            </p>
            <!-- Social Media -->
            <div class="mb-16 flex items-center">
              <a
                ...
                target="_blank"
                class="text-gray-300 mr-3 hover:bg-primary hover:border-primary flex h-10 w-10 items-center justify-center hover:text-white"
              >
                <svg
              ...
              <a
                ...
                target="_blank"
                class="text-gray-300 hover:bg-primary hover:border-primary flex h-10 w-10 items-center justify-center hover:text-white"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  x="0px"
